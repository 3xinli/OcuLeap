...
public class GameManager : MonoBehaviour
{
	...
	private int startGameGesture = 0;
    public CameraFollow cameraFollow;
    int currentBirdIndex;
    public SlingShot slingshot;
    [HideInInspector]
    public static GameState CurrentGameState = GameState.Start;
	public static SlingshotState ss;
    ...
    {
		Vector2 resizeRatio = new Vector2((float)UnityEngine.Screen.width / screenWidth, (float)UnityEngine.Screen.height / screenHeight);
